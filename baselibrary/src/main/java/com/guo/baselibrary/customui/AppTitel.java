package com.guo.baselibrary.customui;
...
import com.guo.baselibrary.R;


public class AppTitel extends LinearLayout {

    private static final String TAG = AppTitel.class.getSimpleName();
    /**
     * 右边不显示
     */
    ...
    public AppTitel(Context context) {
        super(context);

    }

    public AppTitel(Context context, AttributeSet attrs) {

        super(context, attrs);
        TypedArray typeArray = context.obtainStyledAttributes(attrs,
                R.styleable.AppHeader);
        mLeftType = typeArray.getInteger(R.styleable.AppHeader_left, 1);
        mRightType = typeArray.getInteger(R.styleable.AppHeader_right, 1);
        mMiddleType = typeArray.getInteger(R.styleable.AppHeader_middle, 0);
        mBackground = typeArray.getResourceId(R.styleable.AppHeader_backgroundColor, R.color.color_028CE6);
        mLeftSrc = typeArray.getResourceId(R.styleable.AppHeader_src_left, R.drawable.selector_head_return);
        mRightSrc = typeArray.getResourceId(R.styleable.AppHeader_src_right, R.drawable.selector_head_return);
        mMiddleSrc = typeArray.getResourceId(R.styleable.AppHeader_src_middle, R.drawable.selector_head_return);
        mLeftText = typeArray.getString(R.styleable.AppHeader_text_left);
        mRightText = typeArray.getString(R.styleable.AppHeader_text_right);
        mTitleText = typeArray.getString(R.styleable.AppHeader_text_title);
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.app_header, null);
